                                ...
                                <tr style="border-collapse:collapse">
                                    <td cellpadding="0" cellspacing="0" border="0"
                                        style="padding:0;Margin:0;line-height:1px;min-width:600px" height="0"><img
                                            src="https://dnqtpa.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png"
                ...
                <tr style="border-collapse:collapse">
                    <td valign="top" style="padding:0;Margin:0">
                        ...
                        <table class="es-header" cellspacing="0" cellpadding="0" align="center"
                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color:#2b2156;background-repeat:repeat;background-position:center top">
                            <tbody>
                                <tr style="border-collapse:collapse">
                        ...
                        <table class="es-content" cellspacing="0" cellpadding="0" align="center"
                            ...
                            <tbody>
                                <tr style="border-collapse:collapse">
                                    <td style="padding:0;Margin:0;background-color:#2b2156" bgcolor="#ffa73b"
                                        align="center">
                                                                                ...
                                                                                <tr style="border-collapse:collapse">
                                                                                    <td class="es-m-txt-l"
                                                                                        ...
                                                                                        <p
                                                                                            ...
                                                                                            get started. you can access the application by click on the button.
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr style="border-collapse:collapse">
                                                                                    <td align="center"
                                                                                        ...
                                                                                        <span class="es-button-border"
                                                                                            style="border-style:solid;border-color:#2b2156;background:1px;border-width:1px;display:inline-block;border-radius:2px;width:auto;mso-border-alt:10px"><a
                                                                                                href="{{ route('home') }}"
                                                                                                class="es-button"
                                                                                                target="_blank"
                                                                                                style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;display:inline-block;background:#2b2156;border-radius:2px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;padding:15px 30px">
                                                                                                Go to Cleopatra</a></span>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr style="border-collapse:collapse">
                                                                                    <td class="es-m-txt-l"
                                                                            ...
                                                                            <tbody>
                                                                                <tr style="border-collapse:collapse">
                                                                                    <td class="es-infoblock made_with"
                                                                                        ...
                                                                                        <a target="_blank"
                                                                                            href="{{ public_path('assets/logo/cleopatra.png') }}"
